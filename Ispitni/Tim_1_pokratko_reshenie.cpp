...
class FootballTeam {
    ...
    void copy (const FootballTeam &ft) {
        ...
        strcpy(this->name,ft.name);
        this->medalsOrMatches=ft.medalsOrMatches;
    }
    ...
    FootballTeam(char * coach, int * goals, int number, char * name, int m) {
    ...
    virtual float achievement () {
        int sum = 0 ;
        for (int i=0;i<number;i++)
            sum+=goals[i];
        
        return sum*coef+medalsOrMatches;
    }
...
class Club : public FootballTeam {   
    ...
    Club(char * coachName, int * goals, int no, char * name, int  medals) : FootballTeam(coachName,goals,no, name, medals) {
    ...
    friend ostream &operator << (ostream &out, const Club &c) {
        ...
        for (int i=0;i<c.number;i++)
           out<<" "<<c.goals[i];
        out<<", club name: "<<c.name<<", medals: "<<c.medalsOrMatches<<endl;
        return out;
    }
...
class NationalTeam : public FootballTeam {
    ...
    NationalTeam(char * coachName, int * goals, int no, char * country, int  matches) : FootballTeam(coachName,goals,no, country, matches) {
    ...
    friend ostream &operator << (ostream &out, const NationalTeam &c) {
        ...
        for (int i=0;i<c.number;i++)
           out<<" "<<c.goals[i];
        out<<", country name: "<<c.name<<", matches: "<<c.medalsOrMatches<<endl;
        return out;
    }
